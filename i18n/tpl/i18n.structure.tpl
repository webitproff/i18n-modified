		...
		<form action="{I18N_ACTION}" method="post">
			<table class="cells">
				...
				<tr>
					...
					<td>
						<div>
							<input type="text" name="{I18N_CATEGORY_ROW_ITITLE_NAME}" value="{I18N_CATEGORY_ROW_ITITLE_VALUE}" maxlength="128" size="64" />
						</div>
						<div class="margintop10">
							<textarea name="{I18N_CATEGORY_ROW_IDESC_NAME}" rows="4" cols="64">{I18N_CATEGORY_ROW_IDESC_VALUE}</textarea>
						</div>
					</td>
				</tr>
