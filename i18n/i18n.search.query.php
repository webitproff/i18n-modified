...
if ($i18n_notmain && $i18n_read) {
    ...
    $searchJoinTables[] = 'LEFT JOIN ' . Cot::$db->i18n_pages . ' AS i18n ON p.page_id = i18n.ipage_id '
        . 'AND i18n.ipage_locale = ' . Cot::$db->quote($i18n_locale) . ' AND i18n.ipage_id IS NOT NULL';
}
